...
if has('gui_running') || &t_Co == 88 || &t_Co == 256
  ...
  let s:syntax_fold_bg = s:visual_grey
  ...
  call <sid>X('StatusLine',   s:mono_3,        '',               '')
  ...
  " C/C++ highlighting ------------------------------------------------------{{{
  call <sid>X('cInclude',           s:hue_2,  '', '')
  call <sid>X('cDefine',            s:hue_2,  '', '')
  call <sid>X('cPreCondit',         s:hue_2,  '', '')
  call <sid>X('cPreConditMatch',    s:hue_2,  '', '')

  call <sid>X('cType',              s:hue_3,  '', '')
  call <sid>X('cStorageClass',      s:hue_3,  '', '')
  call <sid>X('cStructure',         s:hue_3,  '', '')
  call <sid>X('cOperator',          s:hue_3,  '', '')
  call <sid>X('cStatement',         s:hue_1,  '', '')
